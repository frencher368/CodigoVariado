...
public class Cifrado
{
    ...
    /**
     * Desncripta el texto segun la matriz
     */
    ...
    int opcion = 0;
    String Texto;
    Cifrado cifradito = new Cifrado();
    cifradito.LlenarMatriz();
				
    // Menu
		
    opcion = Integer.parseInt(JOptionPane.showInputDialog(null,
            "1. Ingrese texto a encriptar \n" +
            "2. Ingrese texto a desencriptar \n" +
            "3. Salir \n" +
            "Elige una opcion... ","Encriptacion",
        ...
        switch (opcion)
        {
            case 1:
                Texto =  JOptionPane.showInputDialog(null,
                        "Ingresa el texto a encriptar: ", "Agregando texto", JOptionPane.QUESTION_MESSAGE);
                        cifradito.EncriptarTexto(Texto);
            break;

            case 2:
                Texto =  JOptionPane.showInputDialog(null,
                        "Ingresa el texto a desencriptar: ", "Agregando texto", JOptionPane.QUESTION_MESSAGE);
                        //cifradito.DesencriptarTexto(Texto);
            break;
